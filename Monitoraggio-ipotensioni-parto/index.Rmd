...
## Descrittive
Le variabili di interesse (pH e lattati) non hanno una distribuzione normale (vedi grafici). I test utilizzati saranno quindi non parametrici (Mann-Whitney per il confronto delle distribuzioni). Per il confronto delle frequenze ̬ stato utilizzato il test $\chi2$.  
